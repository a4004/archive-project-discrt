...
namespace DiscordRT.Modules
{
    public class ChatBot : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Response5()
        {
            ...
            HelpDoc.ImageUrl = "https://raw.githubusercontent.com/a4004/discrt/master/Bot_Resources_Web/DISCRT_LOGO_SMALLER.png";


            HelpDoc.Footer = new EmbedFooterBuilder();
            HelpDoc.Footer.Text = "Contact DiscRT dev or submit issue - Github: https://github.com/a4004/discrt";
